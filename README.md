...
The 2013 site has been retired and rebuilt as a dependency-light static site generated by `build.mjs`.

## Build

```
npm install        # one dependency: sharp (image derivatives)
npm run build      # emits index/ponudba/kontakt.html, sitemap, robots, assets/images/derived/
```
...
| `build.mjs`, `src/templates/` | — | The build script and page templates |
